...
export function Branding({ lng }: { lng: Locale }): React.JSX.Element {
  return (
    <div className="branding flex items-center pr-2 sm:pr-12 transition-colors duration-300 bg-transparent">
