...
/**
 * Markdown representation of a published legal-area page at `/legal/{path}.md`.
...
export const Route = createFileRoute('/$lng/_frontend/legal/{$path}.md')({
  server: {
    handlers: {
      GET: async ({
        params,
        ...
        return pageMarkdownResponse(params.lng, params.path, 'legal', new URL(request.url).search)
      },
    },
  },
})
