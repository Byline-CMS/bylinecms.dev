 ...
 *
 * Compact sits between `minimal` and the full editor: no block
 * structures, but links and inline images survive, because a caption or
 * a credit line usually wants both.
 *
 ...
 * @example
 * ```ts
 * import { compactRichTextAdmin } from '../../../fields/richtext/lexical-richtext-compact-admin.jsx'
 *
 * fields: {
