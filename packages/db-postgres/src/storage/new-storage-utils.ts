...
//           fields: [
//             { name: 'constrainedWidth', type: 'boolean' },
...
// type ExampleData = CollectionFieldDataAllLocales<typeof ExampleCollection>
...
//       display: 'wide',
//       photo: {
//         file_id: '8c9f8a2e-5c3b-4d2e-9f1a-2e5f6a7b8c9d',
...
// const flattened = flattenFieldSetData(ExampleCollection.fields, exampleData, 'all')
// const restored = restoreFieldSetData(ExampleCollection.fields, flattened)
