...
export interface SerializeOptions {
   ...
   * an image inside a text link is reachable — a markdown import turns
   * `[![alt](img)](url)` into a `link` node containing an `inline-image`
   * node, and the image dialog can then give that image a link of its own.
   *
