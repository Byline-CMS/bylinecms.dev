 ...
 * ```
 *
 * Calls to `client.collection('<collection-path>')` are therefore checked
 * against this application's generated registry and return that collection's
 * canonical generated field shape. `collection-types.contract.ts` separately
 * proves that those generated shapes match the runtime schemas exactly.
 *
