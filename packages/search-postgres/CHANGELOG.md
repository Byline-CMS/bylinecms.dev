...
- 2bcf5d7: **`@byline/search-postgres`** added migration `0002_analyzer_fingerprint`, repairing installations whose search schema was left incomplete.
