...
| — | `path` as system attribute — `CreateOptions.path` / `UpdateOptions.path` forward to the lifecycle; see [DOCUMENT-PATHS.md](../../docs/04-collections/04-document-paths.md) | **Shipped** |
