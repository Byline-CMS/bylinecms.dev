...
// ---------------------------------------------------------------------------
// Get document-grain audit log (docs/07-auth-and-security/02-auditability.md — Workstream 3)
// ---------------------------------------------------------------------------
...
export const getCollectionDocumentAuditLog = createServerFn({ method: 'GET' })
  ...
  .handler(async ({ data }) => {
    ...
    // Acting-user labels for the audit list (docs/07-auth-and-security/02-auditability.md — W3). Resolved
