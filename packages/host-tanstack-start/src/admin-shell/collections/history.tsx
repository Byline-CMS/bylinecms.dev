...
export const HistoryView = ({
  ...
  data: AnyCollectionSchemaTypes['HistoryType'] & {
     ...
     * version's `createdBy` id (see docs/07-auth-and-security/02-auditability.md — Workstream 1). Ids
     * absent from the map belong to deleted users.
     */
    actors?: Record<string, { label: string }>
  }
  /**
   * Document-grain audit log for the "Document history" tab (docs/07-auth-and-security/02-auditability.md —
  ...
  // Which sub-view is active (docs/07-auth-and-security/02-auditability.md — W3). Absent / anything but
              ...
              <Table>
                ...
                <Table.Body>
                  {data?.docs?.map((document, rowIndex) => {
                    ...
                    // Audit strip (docs/07-auth-and-security/02-auditability.md — W1): who created this
