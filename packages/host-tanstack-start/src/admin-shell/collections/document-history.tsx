 ...
 * which turns Dates into strings (docs/07-auth-and-security/02-auditability.md — Workstream 3).
 */
...
/**
 * Document-grain audit log for a single document (docs/07-auth-and-security/02-auditability.md — Workstream
