...
For the full design — registration model, plugin extensibility surface, per-user persistence, future phases — see [`docs/08-internationalization/index.md`](../../docs/08-internationalization/index.md) at the repo root.
...
- **Lazy locale loading.** Locales currently bundle eagerly. With more than ~5 locales, switching to async loaders earns its complexity; see Phase 3 in [`docs/08-internationalization/index.md`](../../docs/08-internationalization/index.md).
