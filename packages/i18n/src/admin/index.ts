...
const es: NamespaceTranslations = esJson
const de: NamespaceTranslations = deJson
 ...
 * eagerly; lazy loading is the [Phase 3](../../docs/08-internationalization/index.md#phase-3--lazy-locale-loading)
