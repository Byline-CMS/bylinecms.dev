...
> intended as a handoff brief for implementation work (e.g. in Claude Code). Factual claims about
> third-party tools, licenses, pricing, and benchmarks reflect research as of **June 2026** and
> should be re-verified against current vendor/model documentation before committing to any one of
