...
Companions:
- [ROUTING-API.md](./02-routing-and-api.md) — the server-function transport layer that public reads ride on.
- [AUTHN-AUTHZ.md](../06-auth-and-security/01-authn-authz.md) — the admin session and preview-cookie mechanics that the cache layer keys off.
