...
**Remaining:** a `docs/MARKDOWN-EXPORT.md` present-state doc (including the GFM-alert vs `:::` importer dialect asymmetry) and the docs-corpus round-trip test (import → export convergence over `docs/*.md`).
