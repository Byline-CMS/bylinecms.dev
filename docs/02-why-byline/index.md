...
title: "Why Byline"
path: "why-byline"
summary: "The thinking behind Byline: why it exists, the problems it sets out to solve, and what it means to build a content platform for an era in which both people and machines read your content."
---
...
- [Mission & Vision](./01-mission.md) — why Byline exists, the three pillars it
  is built on, and the stance it takes on data ownership and open development.
...
rationale, jump to [Architecture](../03-architecture/index.md).
